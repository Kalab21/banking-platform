...
services), 842 automated tests in CI, 34 live-stack scenarios on demand, and a
...
842 automated tests run in CI:

| Suite | Count |
|---|---|
| Backend unit and web-slice (JUnit 5, Mockito, MockMvc) | 515 |
| Backend integration against real PostgreSQL and an embedded Kafka broker | 45 |
