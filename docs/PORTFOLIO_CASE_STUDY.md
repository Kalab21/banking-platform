...
services), 825 automated tests in CI, 34 live-stack scenarios on demand, and a
...
825 automated tests run in CI:

| Suite | Count |
|---|---|
| Backend unit and web-slice (JUnit 5, Mockito, MockMvc) | 512 |
| Backend integration against real PostgreSQL and an embedded Kafka broker | 31 |
