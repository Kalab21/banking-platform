...
| **Testing** | 342 automated tests in CI (JUnit 5, Mockito, Testcontainers, Vitest, Playwright), plus 9 live-stack Playwright scenarios on demand |
...
```bash
mvn -B --no-transfer-progress clean verify   # backend: 245 unit + 14 integration
