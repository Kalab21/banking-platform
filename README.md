...
| **Testing** | 345 automated tests in CI (JUnit 5, Mockito, Testcontainers, Vitest, Playwright), plus 9 live-stack Playwright scenarios on demand |
...
**345 automated tests run in CI** — 262 backend, 70 frontend unit/component and 13
...
```bash
mvn -B --no-transfer-progress clean verify   # backend: 245 unit + 17 integration
