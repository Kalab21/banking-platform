...
**Engineering proof:** 13 backend processes · 752 CI tests · idempotent money movement ·
...
| **Testing** | 752 tests in CI (JUnit 5, Mockito, Testcontainers, Vitest, Playwright), plus 34 live-stack Playwright scenarios and a PowerShell full-stack suite on demand |
...
| Evidence | Result |
|---|---:|
| Backend — unit, web-slice and Testcontainers integration | 470 |
