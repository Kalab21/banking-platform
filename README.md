...
**Engineering proof:** 13 backend processes · 825 CI tests · idempotent money movement ·
...
| **Testing** | 825 tests in CI (JUnit 5, Mockito, Testcontainers, Vitest, Playwright), plus 34 live-stack Playwright scenarios and a PowerShell full-stack suite on demand |
...
| Evidence | Result |
|---|---:|
| Backend — unit, web-slice and Testcontainers integration | 543 |
...
The backend total is 512 unit and web-slice tests plus 31 integration tests that run
