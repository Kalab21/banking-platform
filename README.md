...
**Engineering proof:** 13 backend processes · 834 CI tests · idempotent money movement ·
...
| **Testing** | 834 tests in CI (JUnit 5, Mockito, Testcontainers, Vitest, Playwright), plus 34 live-stack Playwright scenarios and a PowerShell full-stack suite on demand |
...
| Evidence | Result |
|---|---:|
| Backend — unit, web-slice and Testcontainers integration | 552 |
...
The backend total is 512 unit and web-slice tests plus 40 integration tests that run
