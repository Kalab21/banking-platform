...
**Engineering proof:** 13 backend processes · 842 CI tests · idempotent money movement ·
...
| **Testing** | 842 tests in CI (JUnit 5, Mockito, Testcontainers, Vitest, Playwright), plus 34 live-stack Playwright scenarios and a PowerShell full-stack suite on demand |
...
| Evidence | Result |
|---|---:|
| Backend — unit, web-slice and Testcontainers integration | 560 |
...
The backend total is 515 unit and web-slice tests plus 45 integration tests that run
