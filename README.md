...
**Engineering proof:** 13 backend processes · 815 CI tests · idempotent money movement ·
...
| **Testing** | 815 tests in CI (JUnit 5, Mockito, Testcontainers, Vitest, Playwright), plus 34 live-stack Playwright scenarios and a PowerShell full-stack suite on demand |
...
| Evidence | Result |
|---|---:|
| Backend — unit, web-slice and Testcontainers integration | 533 |
...
The backend total is 508 unit and web-slice tests plus 25 integration tests that run
